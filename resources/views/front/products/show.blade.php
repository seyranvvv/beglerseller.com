            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-6">
                    ...
                    <div class="product-details__quantity">
                        ...
                        <div class="mx-4 cursor-pointer --js-favorite-icon --js-add-to-favorites @if ($product->isFavorite()) d-none @endif ">
                        ...
                        <div class="mx-4 cursor-pointer --js-favorite-icon --js-remove-from-favorites @if (!$product->isFavorite()) d-none @endif ">
                            <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path

...
@section('content')
    <div class="justify-content-between align-items-center flex-wrap">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.orders.show', $obj->id) }}">
                        {!! $obj->order->getName() !!}</a>
                </li>
                <li class="breadcrumb-item active">Yzarlama üýtgetmek</li>
            </ol>
        </nav>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="my-4">
                <form action="{{ route('admin.orders.track.update', $obj->id) }}" method="post">
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}
                    <div class="row">
                        <div class="col-md-6">
                            <div class=" form-group">
                                ...
                                <div class="">
                                    <input id="track" type="text"
                                        ...
                                        value="{{ $obj->track->getName() }}" readonly required>
                                    @if ($errors->has('track'))

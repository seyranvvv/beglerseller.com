...
@section('content')
    <div class="justify-content-between align-items-center flex-wrap">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dresses.index') }}">Ýakalar</a></li>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="{{ route('dresses.update', $dress) }}" autocomplete="off"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="name" value="{{ old('name', $dress->name) }}" id="name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" rows="10" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"
                                            name="description" id="description">{{ old('description', $dress->description) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            name="order" min="0" value="{{ old('order', $dress->order) }}"
                                            id="order">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="0.00"
                                            ...
                                            name="price" value="{{ old('price', price_format($dress->price)) }}"
                                            id="price">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label d-inline-block">
                                            <input type="checkbox" name="active" class="form-check-input" value="1"
                                                {{ old('active', $dress->active) ? 'checked' : '' }}>
                                            Görkezilýär
                                        </label>
                                    </div>

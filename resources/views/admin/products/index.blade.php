...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="h3 mb-3">@lang('transAdmin.products')</div>
        <a href="{{ route('admin.products.create') }}" class="btn btn-sm btn-primary">
            <i class="fa fa-plus"></i>+ @lang('transAdmin.product')
        </a>
    </div>
    <div class="card">
        <div class="card-body">
            <table class="table bg-white mt-4">
                ...
                <tbody>
                    @forelse($objs as $obj)
                        <tr>
                            @include('admin.products.index.images')
                            @include('admin.products.index.title')
                            @include('admin.products.index.buttons')
                        </tr>
                    @empty
                        <tr>

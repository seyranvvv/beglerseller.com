...
@section('title')
    @lang('transAdmin.stores')
@endsection
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        <div class="h3 mb-3">@lang('transAdmin.stores')</div>
        <a href="{{ route('admin.stores.create') }}" class="btn btn-primary">
            + @lang('transAdmin.store')
        </a>
    </div>
    <div class="card">
        <div class="card-body">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                            ...
                                            <a class="dropdown-item d-flex align-items-center"
                                                href="{{ route('admin.stores.edit', $obj->id) }}">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-right">
                                                <form action="{{ route('admin.stores.delete', $obj->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center bg-light text-secondary">
                                <i class="fas fa-exclamation-circle"></i> @lang('transAdmin.store') @lang('transAdmin.not-found')
                            </td>
                        </tr>
                    @endforelse
                </tbody>

...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="h3 mb-3">@lang('transAdmin.visitor-panel')</div>
        <div class="d-inline-flex">
            <div class="dropdown mr-2">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dmb1">
                    <a class="dropdown-item" href="{!! route('admin.visitor-panel', ['api' => 1, 'robot' => $robot]) !!}">
                        @lang('transAdmin.api')
                    </a>
                    <a class="dropdown-item" href="{!! route('admin.visitor-panel', ['api' => 0, 'robot' => $robot]) !!}">
                        @lang('transAdmin.web')
                    </a>
                </div>
            </div>
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dmb2">
                    <a class="dropdown-item" href="{!! route('admin.visitor-panel', ['api' => $api, 'robot' => 0]) !!}">
                        @lang('transAdmin.human')
                    </a>
                    <a class="dropdown-item" href="{!! route('admin.visitor-panel', ['api' => $api, 'robot' => 1]) !!}">
                    ...
                    <div class="card shadow my-3">
                        <div class="card-header py-3">
                            <div class="h6 mb-0">
                                ...
                                <span class="text-secondary">(1 @lang('transAdmin.year') - {!! $days->sum('count') !!}
                                    @lang('transAdmin.visitor'))</span>
                            </div>
                        </div>
